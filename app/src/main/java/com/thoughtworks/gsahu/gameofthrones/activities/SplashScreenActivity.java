...
import com.thoughtworks.gsahu.gameofthrones.services.JSONManagerService;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Creating intent for JSONManagerService
        intent = new Intent(this, JSONManagerService.class);

        if(hasPermissions()) {
            Log.d(LOG_TAG, "Starting JSONManagerService...");
            startService(intent);
